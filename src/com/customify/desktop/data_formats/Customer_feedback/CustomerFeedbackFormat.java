package com.customify.desktop.data_formats.Customer_feedback;
...
public class CustomerFeedbackFormat implements Serializable {
    ...
    public CustomerFeedbackFormat(Keys key, String customer_name, int business_id, String title, String description) {
        this.key = key;
